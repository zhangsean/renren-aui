  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__log-login">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item>
          <el-input v-model="dataForm.createrName" :placeholder="$t('logLogin.createrName')" clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @sort-change="dataListSortChangeHandle" style="width: 100%;">
        <el-table-column prop="createrName" :label="$t('logLogin.createrName')" header-align="center" align="center"></el-table-column>
